...
@Component({
  ...
  templateUrl: './analyst-ratings-opportunities-list.component.html',
  styleUrls: ['./analyst-ratings-opportunities-list.component.scss']
})
export class AnalystRatingsOpportunitiesListComponent implements OnInit {
  ...
  @Input() demo;
    ...
    getAnalystRatingsWithDate(timeRange = null) {
      ...
      this.contentService.getAnalystRatingsWithDate(date, this.selectedTimeRange, this.dataCount).subscribe(x => {
        this.rows = x;
        this.tempData = x;
